...
describe("장바구니 페이지 테스트", () => {
  ...
  it("페이지에 장바구니 상품이 렌더링되고 삭제할 수 있다", async () => {
    ...
    (cartItemsApi.delete as ReturnType<typeof vi.fn>).mockImplementation(
      async (id: number) => {
  ...
  it("수량 조절 버튼을 클릭해 수량을 조절 할 수 있다", async () => {
    ...
    (cartItemsApi.patch as ReturnType<typeof vi.fn>).mockImplementation(
