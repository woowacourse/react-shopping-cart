  ...
  switch (action.type) {
    case ADD_CART_ITEM_REQUEST:
      return produce(state, (draft: Draft<CartState>) => {
        draft.cartItems.status = AsyncStatus.PENDING;
        draft.cartItems.error = null;
      });

    case ADD_CART_ITEM_SUCCESS:
      return produce(state, (draft: Draft<CartState>) => {
        draft.cartItems.status = AsyncStatus.SUCCESS;
        draft.cartItems.error = null;
    ...
    case ADD_CART_ITEM_FAILURE:
      return produce(state, (draft: Draft<CartState>) => {
        draft.cartItems.status = AsyncStatus.FAILURE;
    ...
    case CHECK_CART_ITEM:
      return produce(state, (draft: Draft<CartState>) => {
        ...
        draft.cartItems.status = AsyncStatus.IDLE;
      });
