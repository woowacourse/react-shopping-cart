...
export const handlers = [
  // 장바구니 목록 조회
  http.get(API_END_POINTS.CART_ITEMS, () => {
    return HttpResponse.json(serverCartItems);
  }),

  // 장바구니 개수 변경
  http.patch(`${API_END_POINTS.CART_ITEMS}/:cartItemId`, async ({ params, request }) => {
  ...
  // 장바구니 아이템 삭제
  http.delete(`${API_END_POINTS.CART_ITEMS}/:cartItemId`, ({ params }) => {
