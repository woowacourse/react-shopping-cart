...
describe('useBestCouponCombination', () => {
  ...
  it('단일 쿠폰 조합에서 가장 큰 할인을 선택한다', async () => {
    ...
    >;
    const mockGetAllCouponCombinationIds =
    ...
    mockGetAllCouponCombinationIds.mockReturnValue([[1], [4], [2]]);
    ...
    const { result } = renderHook(() =>
      useBestCouponCombination(availableCoupons, false)
    );
  ...
  it('복합 쿠폰 조합에서 가장 큰 할인을 선택한다', async () => {
    ...
    mockGetAllCouponCombinationIds.mockReturnValue([
      [1], // 5,000원
      [4], // 60,000원
      [2], // 10,000원
  ...
  it('빈 조합에서 기본값을 반환한다', async () => {
    ...
    const { result } = renderHook(() => useBestCouponCombination([], false));
  ...
  it('동일한 할인 금액일 때 첫 번째 조합을 반환한다', async () => {
    ...
    mockGetAllCouponCombinationIds.mockReturnValue([[1], [2]]);
  ...
  it('제주도 조건에 따른 할인 계산이 다르게 적용된다', async () => {
    ...
    mockGetAllCouponCombinationIds.mockReturnValue([[3]]);
    ...
    const { result: jejuResult } = renderHook(() =>
      useBestCouponCombination(availableCoupons, true)
    );
