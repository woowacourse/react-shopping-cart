...
import {finalOrderAmountState, totalItemsPriceSelector,} from "@/recoil/orderInformation.ts";
...
const PriceSection = ({isApplyCoupon}: Props) => {
    ...
    const totalDiscountAmount = calculateTotalDiscount(coupons, totalItemsPrice);
